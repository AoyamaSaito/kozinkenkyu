...
const CLUES = [
  ...
  { id: 'p1_02', title: '先遣隊 活動記録', phase: 1, text: '[██年██月██日] 第3日。B区画の調査を継続。設備の劣化が激しいが通行に支障なし。明日は奥の区画に入る予定。──以降の記録はない。' },
  ...
  { id: 'p4_03', title: '灰と防護服', phase: 4, text: '隔離区画の奥に、防護服が一着。中身は灰だけ。他の隊員の身体にはまだ人の形が残っていたはず。' },
...
var gm3 = '【GM 通信（全員宛）】重要な報告です。本部の記録では、第二次探索チームの正規メンバーは3名です。しかし現在、施設内には4名います。1人、想定外の人物が紛れ込んでいます。'
