...
PROFESSOR_INITIAL = [
    ...
    ("body", (
        ...
        "今回の調査には、指導する院生を伴って参加した。先遣隊の通信途絶という事態に、"
        "あなたの専門知識が求められたからだ。\n\n"
...
STUDENT_INITIAL = [
    ...
    ("body", (
        "教授のゼミで認知科学を専攻する大学院生。"
        "今回の調査には好奇心から強く志願して参加した。"
        "フィールドワークの経験はあるが、こんな施設は初めてだ。\n\n"
        "教授の理論を間近で検証できる好機。"
        "自分の目で確かめ、自分の頭で考えたい──その知的好奇心が、あなたをここに連れてきた。",
        [])),
    ("title", "あなたの状況"),
    ("body", (
        "施設に入った途端、出口が封鎖された。\n\n"
        ...
        "教授は何か心当たりがあるようだが、全てを話してはいない気がする。",
        [])),
    ("title", "目　標"),
    ("mission", [
        "教授の理論を自分なりに検証する",
